...
<div class="row-fluid slider-wrapper theme-laguardalowSlider">
  <div id="slider" class="nivoSlider">
    ...
    <img src="<?php echo get_home_url() ?>/wp-content/uploads/2018/05/LLA_Homepage7.jpg" alt=""  title="#htmlcaption"/>
    <img src="<?php echo get_home_url() ?>/wp-content/uploads/2018/05/LLA_Homepage4.jpg" alt=""  title="#htmlcaption"/>
    <img src="<?php echo get_home_url() ?>/wp-content/uploads/2018/05/LLA_Homepage5.jpg" alt=""  title="#htmlcaption"/>
  </div>
